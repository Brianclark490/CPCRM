...
import { handleGetComponentRegistry } from './routes/adminPageLayouts.js';
...
app.get('/api/admin/component-registry', requireAuth, requireTenant, handleGetComponentRegistry);
